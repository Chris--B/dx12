...
impl Config {
    pub fn load() -> Config {
        ...
        Config {
            force_warp:      matches.is_present("warp"),
            enable_debug:  !matches.is_present("no-debug-layer"),
...
impl Into<u32> for Dx12FeatureLevel {
    fn into(self) -> u32 {
        match self {
            Dx12FeatureLevel::E11_0 => winapi::um::d3dcommon::D3D_FEATURE_LEVEL_11_0,
            Dx12FeatureLevel::E11_1 => winapi::um::d3dcommon::D3D_FEATURE_LEVEL_11_1,
            Dx12FeatureLevel::E12_0 => winapi::um::d3dcommon::D3D_FEATURE_LEVEL_12_0,
            Dx12FeatureLevel::E12_1 => winapi::um::d3dcommon::D3D_FEATURE_LEVEL_12_1,
        }
    }
}
